...
## To Receive Data:
After the request has been made, obtain the text from the HTTP response and parse the JSON data using the language of your choice. The JSON object returned will contain one key-value pair: a key "message" and a value containing the message string.
